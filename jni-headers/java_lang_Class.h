 ...
 */
JNIEXPORT jstring JNICALL Java_java_lang_Class_getSigName
  (JNIEnv *, jobject);
...
/*
 * Class:     java_lang_Class
 * Method:    getDeclaredAnnotationsImpl
 * Signature: ()Ljava/util/Map;
 */
JNIEXPORT jobject JNICALL Java_java_lang_Class_getDeclaredAnnotationsImpl
  (JNIEnv *, jobject);
